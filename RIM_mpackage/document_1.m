<?xml version="1.0" encoding="UTF-8" standalone="no" ?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:pPr><w:pStyle w:val="code"/></w:pPr><w:r><w:t><![CDATA[classdef InterfaceAlgoRIM21 < matlab.apps.AppBase
...
% ----- IF PREVIEW
            ...
            if varShowImages == 1
                ...
                % rimFullProcV2
                [ inputVar, medVar ] = rimFullProcV2(img, varExpFactorFieldValue, cutFreq, otfCol, preFilt,...
                varShowImages);
...
% ----- NO PREVIEW
                ...
                [otfs, otfCol, otfIllu, preFilt ] = otfsCalculation(app,varPathPsfEmission, varFilePsfEmission,...
                varExpFactorPSFFieldValue,curSize,varPathPsfExcitation,varFilePsfExcitation,...
                varWienerParamFieldValue,numFilt);
                ...
                [nbImg, speckleMin, speckleMax] = reconstructionMilestones (app, tiffFiles, varFolderValue,... 
                varSpeckleperimage, nbFile, varOverlapStream);
                ...
                tStartPrev = tic;
                 ...
                 try
                   ...
                   if app.StreamGroup.SelectedObject ~= app.OnlyOneFileButton
                    ...
                    reconstruction(app,tiffFiles,varFolderValue,app.expFactorField.Value,app.pathPsfEmission,...
                    app.filePsfEmission,app.expFactorPSFField.Value,app.pathPsfExcitation,app.filePsfExcitation,...
                    app.numItField.Value,app.wienerParamField.Value,varshowImages, app.SpeckleperimageField.Value,...
                    app.OverlapField.Value, app.RegularizationparameterSpinner.Value, '');
